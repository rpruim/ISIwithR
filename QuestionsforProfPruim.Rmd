...
Example and Exploration 7.2 includes simulation in difference in mean by shuffling (not paired). How to do this with data organized for paired? (please see dataset "FirstBase"")
